 ...
 * @author larissa
 */
public class TesteProdutoView extends javax.swing.JFrame {

    /**
     * Creates new form TesteProdutoView
     */
    public TesteProdutoView() {
        initComponents();
       carregarTabela();
    }
    ...
    private void carregarTabela(){
        ...
        TableModelItemCompra modelo = new TableModelItemCompra(dao.listarItensCompra());
    ...
    private void initComponents() {
        ...
        abas.addTab("Historico de Compras", jPanel3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TesteProdutoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TesteProdutoView().setVisible(true);
            }
        });
    }
